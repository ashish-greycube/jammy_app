...
// import Datejs;
// import defaultExport from Datejs;
{% include "erpnext/public/js/head.html" %}
{% include "erpnext/public/js/customer_statement.html" %}
{% include "erpnext/public/js/customer_letter_print.html" %}
